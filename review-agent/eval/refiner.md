...
You are the engineer improving the reviewer. You have the evidence report showing where the automated
review agent disagreed with the principal expert.
...
- The current reviewer prompt: `review-agent/review/reviewer.md`.
...
- A proposed diff to `review-agent/review/reviewer.md`, with a short rationale tying each change to the
  cited evidence.
